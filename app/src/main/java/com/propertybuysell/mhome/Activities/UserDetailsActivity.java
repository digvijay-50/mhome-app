...
public class UserDetailsActivity extends RuntimePermissionsActivity implements NetworkStateReceiver.NetworkStateReceiverListener {
    ...
    EditText emailidet, firstnameet, etconfirmpassword, phone_et,et_loc,et_city,et_state,et_address;
    EditText etpassword;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        StringArrayAdapter adapterbysell = new StringArrayAdapter(UserDetailsActivity.this,
                R.layout.single_spinnerlist, arrayListsellbuy);
        spinner_buysell.setAdapter(adapterbysell);
            ...
            public void onResponse(Call<ProfileUpdateModel> call, Response<ProfileUpdateModel> response) {
                try {
                    ...
                    if (registerDetailModel.getSuccess().equalsIgnoreCase("1")) {
                        ...
                        SavePref.setUserEmail(registerDetailModel.getEmail());
                        SavePref.setUserphone(registerDetailModel.getPhone());
                        SavePref.setUsername(registerDetailModel.getName());
...
//        searchView.getActionView();
    ...
    public void pdialog(){
        ...
        Permissions.check(UserDetailsActivity.this/*context*/, permissions, rationale, options, new PermissionHandler() {

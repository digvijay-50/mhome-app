...
import com.propertybuysell.mhome.Fragments.HomeFragment;
import com.propertybuysell.mhome.Fragments.PackageFragment;
import com.propertybuysell.mhome.Fragments.ProfileFragment;
import com.propertybuysell.mhome.Fragments.ShortlistFragment;
...
public class NewHomeActivity extends AppCompatActivity implements NetworkStateReceiver.NetworkStateReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savePref = new SavePref(NewHomeActivity.this);
                ...
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        if (item.getItemId()==R.id.action_home){
                            ...
                            savePref.setpage(0);
                            tv_top.setText("Home");
                        }else  if (item.getItemId()==R.id.action_short){
                            savePref.setpage(1);
                            viewPager.setCurrentItem(1);
                            tv_top.setText("Shortlisted");
                        }else  if (item.getItemId()==R.id.action_package){
                            savePref.setpage(2);

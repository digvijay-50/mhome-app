...
import static com.propertybuysell.mhome.RetrofitUtils.Constant.checkpurchase;
...
public class AddPostfourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savePref = new SavePref(AddPostfourthActivity.this);
        recycler.setLayoutManager(new GridLayoutManager(AddPostfourthActivity.this, 3));
        retrofitService = ApiBaseUrl.getClient().create(RetrofitService.class);


//        Log.i("onCreate", "onCreate: "+android.os.Build.VERSION_CODES.S);
        ...
        im_thumb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CropImage.activity()
                        ...
                        .start(AddPostfourthActivity.this);
...
//                startActivityForResult(Intent.createChooser(intent, "Select Image"), 10002);
            ...
            public void onClick(View v) {
                if (validation()) {
                    ...
                    if (checkpurchase.equalsIgnoreCase("0")) {
                        ...
                        opendialog();
                        //  Toast.makeText(AddPostfourthActivity.this, "Please Purchsed Plan", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void opendialog() {
        ...
        final Dialog dialog = new Dialog(AddPostfourthActivity.this);
        dialog.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
        dialog.setContentView(R.layout.dialog_purchse);
        ...
        tvcancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SplashActivity.disablefor1sec(v);
                savePref.setpage(0);
                Intent i = new Intent(AddPostfourthActivity.this, NewHomeActivity.class);
                startActivity(i);
                dialog.dismiss();
            }
        });

        final TextView tvpurchase = dialog.findViewById(R.id.tvpurchase);
...
//                            .into(im_thumb);
    ...
    public void checkPermissionOfStorage1() {
        ...
        Permissions.check(AddPostfourthActivity.this, permissions, rationale, options, new PermissionHandler() {
    ...
    private void add_image_storage(String path) {
        ...
        retrofitService.add_image_storage(partimag).enqueue(new Callback<ImagestorageModel>() {
            @Override
            public void onResponse(Call<ImagestorageModel> call, final retrofit2.Response<ImagestorageModel> response) {
                try {
                    Log.i("onResponse", "onResponse: "+response.body().getJsonData().get(0).getImage_path());
                    Toast.makeText(AddPostfourthActivity.this, "" + response.body().getJsonData().get(0).getMsg(), Toast.LENGTH_SHORT).show();
                    arrayList.add(new ImageaddModel(response.body().getJsonData().get(0).getImage_path()));
                    recycler.setAdapter(new ImageAdapter(AddPostfourthActivity.this, arrayList));
                    hideLoader();
                } catch (Exception e) {
                    hideLoader();
                }
...
//        }else{
        ...
        retrofitService.add_property(
                ...
                getRequestBody(property_facing),
                getRequestBody("0"),
                partpdf,
            ...
            public void onResponse(Call<UpdateModel> call, Response<UpdateModel> response) {
                try {
                    ...
                    Toast.makeText(AddPostfourthActivity.this, "" + registerDetailModel.getMsg(), Toast.LENGTH_SHORT).show();

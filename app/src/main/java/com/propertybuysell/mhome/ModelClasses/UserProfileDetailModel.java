...
public class UserProfileDetailModel implements Serializable {
    ...
    @SerializedName("user_buy_sell_name")
    @Expose
    private String user_buy_sell_name;

    public String getUser_buy_sell_name() {
        return user_buy_sell_name;
    }

    public void setUser_buy_sell_name(String user_buy_sell_name) {
        this.user_buy_sell_name = user_buy_sell_name;
    }
